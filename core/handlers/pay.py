...
async def order(message: Message, bot: Bot):
    await bot.send_invoice(
        ...
        title='Рыжий котяра',
        description='Продается котеночек',
        payload='Payment through a bot',
        provider_token='381764678:TEST:49553',
        currency='rub',
        prices=[
            LabeledPrice(
                label='Стоимость кота',
                amount=99000
            ),
            LabeledPrice(
                label='НДС',
        ...
        provider_data=None,
        photo_url='https://i.pinimg.com/564x/f4/d2/96/f4d2961b652880be432fb9580891ed62.jpg',
        photo_size=100,
        photo_width=800,
        photo_height=450,
        need_name=False,
